...
func MessageResponse(text string, className string, children ahtempl.Component) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `content/lib/components/ai/message/message_response.templ`, Line: 1, Col: 0}
		}
		...
		if text != "" {
			templ_7745c5c3_Err = streamdown.SvelteStreamdown(text, "size-full [&>*:first-child]:mt-0 [&>*:last-child]:mb-0").Render(ctx, templ_7745c5c3_Buffer)
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
