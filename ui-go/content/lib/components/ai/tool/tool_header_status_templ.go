...
func ToolHeaderStatus(state string, queued bool, className string) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if effective != "output-available" {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `content/lib/components/ai/tool/tool_header_status.templ`, Line: 1, Col: 0}
			}
			...
			case "queued", "approval-requested":
				templ_7745c5c3_Err = lucide.Clock(ahtempl.Attributes{"class": "size-4 shrink-0"}).Render(ctx, templ_7745c5c3_Buffer)
				if templ_7745c5c3_Err != nil {
					return templ_7745c5c3_Err
				}
			case "approval-responded":
				templ_7745c5c3_Err = lucide.CircleCheck(ahtempl.Attributes{"class": "size-4 shrink-0"}).Render(ctx, templ_7745c5c3_Buffer)
				if templ_7745c5c3_Err != nil {
					return templ_7745c5c3_Err
				}
			case "output-error", "output-denied":
				templ_7745c5c3_Err = lucide.CircleX(ahtempl.Attributes{"class": "size-4 shrink-0"}).Render(ctx, templ_7745c5c3_Buffer)
				if templ_7745c5c3_Err != nil {
					return templ_7745c5c3_Err
				}
			}
			var templ_7745c5c3_Var4 = []any{map[bool]string{true: "font-medium", false: ""}[isToolPreparingState(effective)]}
