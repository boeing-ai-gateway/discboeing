...
MODULE_PATH = pathlib.Path(__file__).with_name("discobot-vnc-websockify")


loader = importlib.machinery.SourceFileLoader("discobot_vnc_websockify", str(MODULE_PATH))
