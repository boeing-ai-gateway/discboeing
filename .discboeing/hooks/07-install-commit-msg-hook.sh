...
workspace_root="${DISCBOEING_WORKSPACE:-/home/discboeing/workspace}"
...
managed_marker="# discboeing:managed-commit-msg"
...
#!/bin/bash
# Auto-generated by discboeing session hook
# Source: .discboeing/hooks/07-install-commit-msg-hook.sh
# DO NOT EDIT — regenerated when the session starts
# discboeing:managed-commit-msg
set -euo pipefail
