...
| Area                        | Current Tauri-specific detail                                                                               | Evidence                                                                                                                                |
| --------------------------- | ----------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------- |
| Custom drag regions         | The app uses shell-neutral `data-desktop-drag-region`, `.desktop-drag-region`, and `.desktop-no-drag` names. | `ui/src/app.css:763-773`, `ui/src/lib/components/app/AppHeader.svelte:40-46`, `ui/src/lib/components/app/SessionToolbar.svelte:352-358` |
