...
import type { components as OpenAPIComponents } from "./api-types.generated";
...
export type SessionThreadStatus = OpenAPISchemas["SessionThreadStatus"];

export type Session = OpenAPISchemas["Session"];
...
export type Workspace = OpenAPISchemas["Workspace"];
...
export type SystemStatusResponse = OpenAPISchemas["SystemStatusResponse"];
...
export type StartupTask = OpenAPISchemas["StartupTask"];
...
export type ChatStreamSocketEventName = OpenAPISchemas["ChatStreamEventName"];
export type ProjectStreamType = OpenAPISchemas["ProjectStreamType"];
export type ProjectEventName = OpenAPISchemas["ProjectEventName"];
export type ProjectEventsStreamMessage =
	OpenAPISchemas["ProjectEventsStreamMessage"];
export type ProjectEventBase = OpenAPISchemas["ProjectEventBase"];
export type ProjectConnectedEvent = OpenAPISchemas["ProjectConnectedEvent"];
export type SessionUpdatedEvent = OpenAPISchemas["SessionUpdatedEvent"];
export type ThreadUpdatedData = OpenAPISchemas["ThreadUpdatedData"];
export type ThreadUpdatedEvent = OpenAPISchemas["ThreadUpdatedEvent"];
export type WorkspaceUpdatedEvent = OpenAPISchemas["WorkspaceUpdatedEvent"];
export type StartupTaskUpdatedEvent = OpenAPISchemas["StartupTaskUpdatedEvent"];
export type ProjectStreamSubscribedEvent =
	OpenAPISchemas["ProjectStreamSubscribedEvent"];
export type ProjectStreamUnsubscribedEvent =
	OpenAPISchemas["ProjectStreamUnsubscribedEvent"];
export type ProjectStreamCompleteEvent =
	OpenAPISchemas["ProjectStreamCompleteEvent"];
export type ProjectStreamErrorEvent = OpenAPISchemas["ProjectStreamErrorEvent"];
export type ChatStreamMessage = OpenAPISchemas["ChatStreamMessage"];
export type SessionStreamEventName = OpenAPISchemas["SessionStreamEventName"];
export type SessionStreamMessage = OpenAPISchemas["SessionStreamMessage"];
export type ServiceOutputStreamMessage = OpenAPISchemas["ServiceOutputEvent"];
export type ProjectStreamSocketRequest = OpenAPISchemas["ProjectStreamRequest"];
export type ProjectStreamSocketMessage = OpenAPISchemas["ProjectStreamMessage"];
