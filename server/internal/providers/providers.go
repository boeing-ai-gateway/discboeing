...
const (
	...
	// CategorySandboxProvider is for sandbox infrastructure provider credentials.
	CategorySandboxProvider ProviderCategory = "sandbox-provider"
)
...
var customAuthProviders = []AuthProvider{
	...
	},
	{
		ID:                      "discboeing",
		Name:                    "Discboeing",
		ConfiguredName:          "Discboeing ID",
		Description:             "Discboeing hosted web tools for web search and web fetch",
		SecretLabel:             "Discboeing ID",
		SecretDescription:       "Used to identify you for cloud services.",
		AutoGenerateSecret:      true,
		AutoGeneratePrefix:      "discboeing_",
	...
	},
	{
		...
		Category:    CategorySandboxProvider,
		Icons: []Icon{
